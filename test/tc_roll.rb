...
class TestRoll < Test::Unit::TestCase
  ...
  def test_roll_one_d20
    ...
    roll.send('replace_dice', [MockDie.new(5)], nil)
    result = roll.execute
  ...
  def test_roll_five_d20
    ...
    roll.send('replace_dice', [MockDie.new(3), MockDie.new(1), MockDie.new(1), MockDie.new(15), MockDie.new(10)], nil)
    result = roll.execute
  ...
  def test_roll_one_d20_with_advantage_success
    ...
    roll.send('replace_dice', [MockDie.new(3)], MockDie.new(10))
    result = roll.execute
  ...
  def test_roll_one_d20_with_advantage_fail
    roll = Roll.new(1, 20, true)
    roll.send('replace_dice', [MockDie.new(10)], MockDie.new(3))
    result = roll.execute
